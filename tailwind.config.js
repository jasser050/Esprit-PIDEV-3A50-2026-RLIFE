...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary - Indigo (as specified in design system)
        primary: {
          50: '#EEF2FF',
          100: '#E0E7FF',
          200: '#C7D2FE',
        ...
        // Warning (same as accent for consistency)
        warning: {
          50: '#FFFBEB',
          100: '#FEF3C7',
          200: '#FDE68A',
      ...
      boxShadow: {
        ...
        'soft-xl': '0 20px 25px -5px rgb(0 0 0 / 0.05), 0 8px 10px -6px rgb(0 0 0 / 0.04)',
        'card': '0 1px 3px 0 rgb(0 0 0 / 0.06), 0 1px 2px -1px rgb(0 0 0 / 0.06)',
        'card-hover': '0 4px 6px -1px rgb(0 0 0 / 0.07), 0 2px 4px -2px rgb(0 0 0 / 0.07)',
        'glow-primary': '0 0 20px -5px rgb(79 70 229 / 0.4)',
        'glow-primary-lg': '0 0 40px -10px rgb(79 70 229 / 0.5)',
