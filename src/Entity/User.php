...
// ==========================================
// 🔥 STREAK - DÉLÉGUÉ AU SERVICE
// ==========================================

// User.php - méthode simple sans service


// User.php — ajoute cette méthode (sans service)
public function getHighScoreStreak(?Matiere $matiere = null): array
{
    $evaluations = $this->getEvaluations()->toArray();
...
// ==========================================
// 📊 STATISTIQUES - DÉLÉGUÉ AU SERVICE
// ==========================================
...
// ==========================================
// 🤖 AI STUDY COACH - DÉLÉGUÉ AU SERVICE
// ==========================================
