 ...
 */
final class Version20260207220916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assignment DROP FOREIGN KEY `FK_ASSIGNMENT_USER`');
        $this->addSql('ALTER TABLE assignment CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('DROP INDEX idx_assignment_user ON assignment');
        ...
        $this->addSql('ALTER TABLE deck DROP FOREIGN KEY `FK_DECK_USER`');
        $this->addSql('ALTER TABLE deck CHANGE date_creation date_creation DATETIME NOT NULL');
        $this->addSql('DROP INDEX idx_deck_user ON deck');
        ...
        $this->addSql('ALTER TABLE revision_flashcard DROP FOREIGN KEY `fk_revision_deck`');
        $this->addSql('ALTER TABLE revision_flashcard DROP FOREIGN KEY `fk_revision_flashcard`');
        $this->addSql('ALTER TABLE revision_flashcard DROP FOREIGN KEY `fk_revision_deck`');
        $this->addSql('ALTER TABLE revision_flashcard DROP FOREIGN KEY `fk_revision_flashcard`');
        ...
        $this->addSql('ALTER TABLE recommendation_stress DROP FOREIGN KEY `FK_REC_QUIZ`');
        $this->addSql('ALTER TABLE recommendation_stress DROP FOREIGN KEY `FK_REC_QUIZ`');
        ...
        $this->addSql('DROP INDEX idx_rec_quiz ON recommendation_stress');
        $this->addSql('CREATE INDEX IDX_79005D567C6BD396 ON recommendation_stress (quiz_stress_id)');
