 ...
 */
final class Version20260217201333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin_audit_log ADD CONSTRAINT FK_1F16C5C76352511C FOREIGN KEY (admin_user_id) REFERENCES `user` (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE coin_transaction DROP FOREIGN KEY fk_coin_tx_user_rel_2025');
        ...
        $this->addSql('DROP INDEX idx_revision_deck ON revision_flashcard');
        $this->addSql('CREATE INDEX IDX_D1CD878C48C2A35 ON revision_flashcard (id_deck)');
        ...
        $this->addSql('ALTER TABLE pet DROP FOREIGN KEY fk_pet_user_rel_2025');
        $this->addSql('DROP INDEX idx_pet_user_id ON pet');
        $this->addSql('ALTER TABLE pet ADD type VARCHAR(50) NOT NULL, ADD hunger INT NOT NULL, ADD coins_spent INT NOT NULL, CHANGE name name VARCHAR(100) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coin_transaction ADD CONSTRAINT fk_coin_tx_user_rel_2025 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE pet DROP type, DROP hunger, DROP coins_spent, CHANGE name name VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE pet ADD CONSTRAINT fk_pet_user_rel_2025 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('CREATE INDEX idx_pet_user_id ON pet (user_id)');
